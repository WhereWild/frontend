...
/**
 * Normalizes heatmap cell resolution to backend-accepted bounds.
 *
 * - Returns a sanitized fallback when `value` is missing, non-finite, or <= 0.
 * - Caps valid values at the backend max of 10.
 * - Guarantees a strictly positive return value.
 */
