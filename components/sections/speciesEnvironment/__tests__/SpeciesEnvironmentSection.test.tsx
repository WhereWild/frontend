...
const baseState: SpeciesEnvironmentState = {
  ...
  summaryRanks: { min: null, mean: null, max: null, std: null, range99: null, rbar: null, circular_std: null, unique_classes: null, entropy: null, mode_class: null, selected_class: null },
  summaryComparisons: {
    min: null,
    mean: null,
    max: null,
