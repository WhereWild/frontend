  ...
  return (
    ...
    >
      <View
        ...
        importantForAccessibility={showLoadingState ? 'auto' : 'no-hide-descendants'}
      ...
      <View
        ...
        importantForAccessibility={showEmptyState ? 'auto' : 'no-hide-descendants'}
        onPointerEnter={onPointerEnter}
        onPointerLeave={onPointerLeave}
        onTouchStart={onTouchStart}
        onTouchEnd={onTouchEnd}
      ...
      {isInlineLayout ? (
        <View
          ...
          importantForAccessibility={showInlineResults ? 'auto' : 'no-hide-descendants'}
          onPointerEnter={onPointerEnter}
          onPointerLeave={onPointerLeave}
          onTouchStart={onTouchStart}
          onTouchEnd={onTouchEnd}
        ...
        <View
          ...
          importantForAccessibility={showFloatingResults ? 'auto' : 'no-hide-descendants'}
          onPointerEnter={onPointerEnter}
          onPointerLeave={onPointerLeave}
          onTouchStart={onTouchStart}
          onTouchEnd={onTouchEnd}
          onFocus={onFocus}
          onBlur={onBlur}
          style={!showFloatingResults ? styles.hiddenContentSlot : styles.floatingListSlot}
        >
          <FlatList
            ref={listRef}
            ...
            testID={showFloatingResults && testID ? `${testID}-list` : undefined}
          />
        </View>
      )}
    </View>
